--[[
-- Created by blackyang to handle a 3d matrix input to a linear layer.
-- https://github.com/torch/nn/pull/398
-- ]]

local Linear3D, parent = torch.class('nn.Linear3D', 'nn.Module')
...
Linear3D.sharedAccUpdateGradParameters = Linear3D.accUpdateGradParameters


function Linear3D:__tostring__()
