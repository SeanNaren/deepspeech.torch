--[[
--BasicClassificationCTCTest takes 3 fixed inputs of 5 length, and
 - correctly labels them to 3 labels.
 ]]
require 'nn'
...
totalNet:add(nn.Sequencer(nn.ReLU()))
totalNet:add(nn.BiSequencer(nn.FastLSTM(4,3),nn.FastLSTM(4,3)))
...
local input2 = torch.Tensor({{11,12,13,14,15},{6,7,8,9,10},{1,2,3,4,5}})
...
print(totalNet:forward({totalInput[2]})[1])
