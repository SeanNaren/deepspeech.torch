...
local input1 = torch.rand(80,256)
local input2 = torch.rand(120,256)
local input3 = torch.rand(60,256)
local totalInput = {input1,input2,input3}
local totalTargets = {{2,1,4},{4,1,2},{3,1,6}}
