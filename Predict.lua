...
cmd:option('-rate', 16000, 'Rate of audio (default 16khz)')
cmd:option('-nGPU', 1)
...
local spect = audio.spectrogram(wave, opt.windowSize * 16000, 'hamming', opt.stride * 16000):float() -- freq-by-frames tensor
